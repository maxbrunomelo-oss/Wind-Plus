  ...
  return (
    <div className="p-4 lg:p-6 space-y-5 max-w-screen-2xl mx-auto">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div><h1 className="text-xl font-bold text-gray-900">Relatórios Financeiros</h1><p className="text-sm text-gray-500">Visão consolidada de receita e inadimplência</p></div>
        <button className="flex items-center gap-1.5 text-sm border border-gray-200 rounded-lg px-4 py-2 hover:bg-gray-50 font-medium"><IconDownload size={15} /> Exportar</button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          <DonutChart centerLabel="previsto" centerValue={brl(s.previsto)} data={[
