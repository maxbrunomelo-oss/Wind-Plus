...
import { classes, teacherName, classStudentCount } from '@/lib/windos/mock-data';
...
export default function ClassesPage() {
  const columns: Column<SchoolClass>[] = [
    ...
    { key: 'count', header: 'Alunos', render: c => <span className="text-gray-700 font-medium">{classStudentCount(c.id)}</span> },
